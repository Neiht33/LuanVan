...
export default function Product({ language }) {
    ...
    const arrayVN = ['Tất cả sản phẩm', 'Danh Mục', 'Đồ Chơi', 'Phương Tiện Di Chuyển', 'Bộ Lọc', 'Giá', 'Dưới 200.000', '200.000 - 500.000', '500.000 - 1.000.000', '1.000.000 - 2.000.000', '2.000.000 - 5.000.000', '5.000.000 - 10.000.000', 'Tuổi', '1 - 3 Tuổi', '3 - 6 Tuổi', '6 - 12 Tuổi', 'Trên 12 Tuổi', 'Giới Tính', 'Nam', 'Nữ']
    const arrayEn = ['All products', 'Category', 'Toys', 'Transport', 'Filter', 'Price', '$1 - $10', '$10 - $20', '$20 - $40', '$40 - $80', '$80 - $200', '$200 - $400', 'Age', 'Under 3 years old', '3 - 6', '6 - 12', 'Over 12 years old', 'Gender', 'Male', 'Female']
    const [currentLG, setCurrentLG] = React.useState(arrayVN)
                                ...
                                <Card className="shadow-xl shadow-blue-gray-900/5 rounded-none " style={{ borderTopRightRadius: '10px', borderBottomRightRadius: '10px' }}>
                                    <div className="mb-2 p-4">
                                        <Typography variant="h5" color="blue-gray">
                                            <span className="translate-category">Danh Mục</span>
