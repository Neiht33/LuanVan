    ...
    return (
        <Layout style={{
            ...
            <div className="fixed left-0 bottom-30">
                <button onClick={() => setOpenDrawer(true)} className="lg:hidden fixed left-0 top-32 w-[30px] h-[80px] z-[1000] bg-black text-white text-3xl rounded-tr-xl rounded-br-xl">
