...
function Nav() {
  ...
  return (
    <>
      <Navbar className="nav-main mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4 max-w-full rounded-none bg-transparent" style={{zIndex: '100', position: 'fixed'}}>
        ...
        <MobileNav open={openNav}>
          <div className="container mx-auto">
            ...
            <div className="flex flex-col gap-x-2 sm:flex-row sm:items-center">
              ...
              <Button size="md" className="mt-1 rounded-lg sm:mt-0 text-sm bg-indigo-600" style={{padding: '10px 24px'}}>
                Tìm kiếm
              </Button>
            </div>
          </div>
